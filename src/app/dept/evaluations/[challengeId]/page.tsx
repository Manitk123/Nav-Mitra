                  ...
                  <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    {app.pitchDeckUrl ? (
                      <a 
                        ...
                        target="_blank"
                        className="px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 rounded-md transition-colors border border-gray-200 inline-flex items-center justify-center"
                      >
                        View Pitch Deck
                      </a>
                    ) : (
